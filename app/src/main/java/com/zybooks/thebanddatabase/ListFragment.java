...
public class ListFragment extends Fragment {
    ...
    private static class BandHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Band band) {
            ...
            String nameStr = band.getName();
            if (nameStr.contains("BTS") ) {
                smView.setImageResource(R.drawable.bts_sm);
            }
            else if (nameStr.contains("Nirva")) {
                smView.setImageResource(R.drawable.nirv_sm);
            }
            else if (nameStr.contains("U2")) {
                smView.setImageResource(R.drawable.utwo_sm);
            }
            else if (nameStr.contains("Beatle")) {
                smView.setImageResource(R.drawable.bettles_sm);
            }
